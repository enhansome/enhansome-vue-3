...
* [General](https://github.com/vuejs/awesome-vue) ⭐ 73,547 | 🐛 82 | 📅 2026-09-18
* [Vite](https://github.com/vitejs/awesome-vite) ⭐ 17,248 | 🐛 140 | 🌐 JavaScript | 📅 2026-02-04
...
* [vite](https://github.com/vitejs/vite) ⭐ 82,890 | 🐛 784 | 🌐 TypeScript | 📅 2026-09-19 - Next generation frontend tooling. It's fast.
* [vue-next](https://github.com/vuejs/vue-next) ⭐ 54,412 | 🐛 894 | 🌐 TypeScript | 📅 2026-09-19 - Repo for Vue 3.0
* [headlessui-vue](https://github.com/tailwindlabs/headlessui) ⭐ 28,746 | 🐛 111 | 🌐 TypeScript | 📅 2026-04-13 - A set of completely unstyled, fully accessible UI components for Vue 3, designed to integrate beautifully with Tailwind CSS.
* [vant](https://github.com/youzan/vant) ⭐ 24,383 | 🐛 222 | 🌐 TypeScript | 📅 2026-09-18 - Lightweight Mobile UI Components built on Vue 3
* [vitepress](https://github.com/vuejs/vitepress) ⭐ 18,334 | 🐛 316 | 🌐 TypeScript | 📅 2026-09-13 - Vite & Vue powered static site generator
...
* [particles.vue3](https://github.com/matteobruni/tsparticles/blob/master/components/vue3/README.md) ⭐ 8,985 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-19 - A lightweight library for easily create highly customizable particles animations for websites
...
* [vue-router-next](https://github.com/vuejs/vue-router-next) ⭐ 4,680 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-18 - The Vue 3 official router (WIP)
...
* [Virtua](https://github.com/inokawa/virtua) ⭐ 3,746 | 🐛 59 | 🌐 TypeScript | 📅 2026-09-19 - A zero-config, fast and small (\~3kB) virtual list component for React, Vue and Solid.
...
* [markstream-vue](https://github.com/Simon-He95/markstream-vue) ⭐ 3,011 | 🐛 3 | 🌐 Vue | 📅 2026-09-13 - A Vue 3 streaming Markdown renderer for AI chat, supporting incomplete Markdown, Mermaid, KaTeX, long responses, and streaming code blocks.
...
* [@vuepic/vue-datepicker](https://github.com/Vuepic/vue-datepicker) ⭐ 1,766 | 🐛 26 | 🌐 TypeScript | 📅 2026-07-08 - The most complete datepicker solution for Vue 3
...
* [vue-test-utils-next](https://github.com/vuejs/vue-test-utils-next) ⭐ 1,157 | 🐛 33 | 🌐 TypeScript | 📅 2026-09-18 - The next iteration of Vue Test Utils, targeting Vue 3
...
* [hy-app](https://github.com/MrGao-hy/hy-design-uni) ⭐ 459 | 🐛 1 | 🌐 Vue | 📅 2026-09-17 - A Vue 3 and TypeScript UI component library for UniApp, providing mobile-first components, theme customization, dark mode support, and cross-platform compatibility.
...
* [qalendar](https://github.com/tomosterlund/qalendar) ⭐ 293 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-19 - A component library with an event calendar & datepicker.
...
* [vue-tailwind-datepicker](https://github.com/elreco/vue-tailwind-datepicker) ⭐ 248 | 🐛 47 | 🌐 Vue | 📅 2026-09-18 - A modern datepicker made with Tailwind for Vue 3
...
* [timer-hook](https://github.com/riderx/vue-timer-hook) ⭐ 182 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-19 - Handle timer, stopwatch, and time logic/state in your vue 3 component.
...
* [Vue 3 social sharing](https://github.com/hedint/vue3-social-sharing) ⭐ 23 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-18 - Style agnostic Vue 3 plugin for sharing your links on major social networks.
...
* [vue3-realworld-example-app](https://github.com/mutoe/vue3-realworld-example-app) ⭐ 1,083 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-28 - [Realworld](https://github.com/gothinkster/realworld) ⭐ 84,225 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-26 app implementation using Vue 3 + TypeScript + Composition Api
...
* [CoreUI for Vue](https://github.com/coreui/coreui-vue) ⭐ 642 | 🐛 3 | 🌐 MDX | 📅 2026-09-18 - An Open Source UI components library for Vue 3
...
* [Tailwindadmin](https://github.com/Tailwind-Admin/free-tailwind-admin-dashboard-template) ⭐ 276 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-26 - A free, open-source Shadcn UI admin dashboard template supporting React, Next.js, Angular, and Vue.js.
...
* [vue3-ssr-realworld-example-app](https://github.com/levchak0910/vue3-ssr-realworld-example-app) ⭐ 42 | 🐛 0 | 🌐 Vue | 📅 2022-10-14 - [Realworld](https://github.com/gothinkster/realworld) ⭐ 84,225 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-26 app implementation using Vue 3 with SSR
...
* [vue3-sfc-loader](https://github.com/FranckFreiburger/vue3-sfc-loader) ⭐ 1,356 | 🐛 15 | 🌐 JavaScript | 📅 2024-09-27 - Load .vue files directly from your html/js. No node.js environment, no (webpack) build step.
