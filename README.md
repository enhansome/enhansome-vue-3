...
* [RFCs for substantial changes / feature additions to Vue core](https://github.com/vuejs/rfcs) ⭐ 4,937 | 🐛 63 | 📅 2025-01-08
* [Official Documentation](https://vuejs.org/)
* [Vue Composition API](https://vuejs.org/guide/introduction.html)

## Related awesome lists

* [General](https://github.com/vuejs/awesome-vue) ⭐ 73,550 | 🐛 105 | 📅 2026-07-24
* [Vite](https://github.com/vitejs/awesome-vite) ⭐ 17,238 | 🐛 137 | 🌐 JavaScript | 📅 2026-02-04
...
* [vite](https://github.com/vitejs/vite) ⭐ 82,690 | 🐛 758 | 🌐 TypeScript | 📅 2026-09-04 - Next generation frontend tooling. It's fast.
* [vue-next](https://github.com/vuejs/vue-next) ⭐ 54,302 | 🐛 906 | 🌐 TypeScript | 📅 2026-09-05 - Repo for Vue 3.0
* [headlessui-vue](https://github.com/tailwindlabs/headlessui) ⭐ 28,733 | 🐛 110 | 🌐 TypeScript | 📅 2026-04-13 - A set of completely unstyled, fully accessible UI components for Vue 3, designed to integrate beautifully with Tailwind CSS.
* [vant](https://github.com/youzan/vant) ⭐ 24,382 | 🐛 214 | 🌐 TypeScript | 📅 2026-09-03 - Lightweight Mobile UI Components built on Vue 3
* [vitepress](https://github.com/vuejs/vitepress) ⭐ 18,287 | 🐛 304 | 🌐 TypeScript | 📅 2026-09-04 - Vite & Vue powered static site generator
...
* [particles.vue3](https://github.com/matteobruni/tsparticles/blob/master/components/vue3/README.md) ⭐ 8,977 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-02 - A lightweight library for easily create highly customizable particles animations for websites
...
* [vue-router-next](https://github.com/vuejs/vue-router-next) ⭐ 4,673 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-02 - The Vue 3 official router (WIP)
...
* [Virtua](https://github.com/inokawa/virtua) ⭐ 3,735 | 🐛 61 | 🌐 TypeScript | 📅 2026-09-04 - A zero-config, fast and small (\~3kB) virtual list component for React, Vue and Solid.
...
* [markstream-vue](https://github.com/Simon-He95/markstream-vue) ⭐ 2,988 | 🐛 2 | 🌐 Vue | 📅 2026-09-05 - A Vue 3 streaming Markdown renderer for AI chat, supporting incomplete Markdown, Mermaid, KaTeX, long responses, and streaming code blocks.
...
* [@vuepic/vue-datepicker](https://github.com/Vuepic/vue-datepicker) ⭐ 1,763 | 🐛 25 | 🌐 TypeScript | 📅 2026-07-08 - The most complete datepicker solution for Vue 3
...
* [vue-test-utils-next](https://github.com/vuejs/vue-test-utils-next) ⭐ 1,158 | 🐛 31 | 🌐 TypeScript | 📅 2026-09-05 - The next iteration of Vue Test Utils, targeting Vue 3
...
* [vue3-carousel](https://github.com/ismail9k/vue3-carousel) ⭐ 884 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-07 - Modern lightweight carousel component built for Vue 3.
...
* [hy-app](https://github.com/MrGao-hy/hy-design-uni) ⭐ 453 | 🐛 1 | 🌐 Vue | 📅 2026-08-24 - A Vue 3 and TypeScript UI component library for UniApp, providing mobile-first components, theme customization, dark mode support, and cross-platform compatibility.
...
* [qalendar](https://github.com/tomosterlund/qalendar) ⭐ 292 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-04 - A component library with an event calendar & datepicker.
...
* [timer-hook](https://github.com/riderx/vue-timer-hook) ⭐ 182 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-04 - Handle timer, stopwatch, and time logic/state in your vue 3 component.
* [vue3-datagrid](https://github.com/revolist/vue3-datagrid) ⭐ 179 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-04 - Powerful virtual data grid spreadsheet for Vue 3 with advanced customization based on [revogrid](https://rv-grid.com).
...
* [Vue 3 social sharing](https://github.com/hedint/vue3-social-sharing) ⭐ 22 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-05 - Style agnostic Vue 3 plugin for sharing your links on major social networks.
...
* [Vue USWDS](https://github.com/patrickcate/vue-uswds) ⭐ 11 | 🐛 68 | 🌐 JavaScript | 📅 2026-09-05 - A Vue.js implementation of the USWDS (U.S. Web Design System)
...
* [vue3-realworld-example-app](https://github.com/mutoe/vue3-realworld-example-app) ⭐ 1,083 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-28 - [Realworld](https://github.com/gothinkster/realworld) ⭐ 84,193 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-26 app implementation using Vue 3 + TypeScript + Composition Api
...
* [Tailwindadmin](https://github.com/Tailwind-Admin/free-tailwind-admin-dashboard-template) ⭐ 270 | 🐛 1 | 🌐 TypeScript | 📅 2026-05-26 - A free, open-source Shadcn UI admin dashboard template supporting React, Next.js, Angular, and Vue.js.
...
* [vue3-ssr-realworld-example-app](https://github.com/levchak0910/vue3-ssr-realworld-example-app) ⭐ 42 | 🐛 0 | 🌐 Vue | 📅 2022-10-14 - [Realworld](https://github.com/gothinkster/realworld) ⭐ 84,193 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-26 app implementation using Vue 3 with SSR
