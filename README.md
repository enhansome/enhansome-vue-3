...
* [General](https://github.com/vuejs/awesome-vue) ⭐ 73,545 | 🐛 105 | 📅 2026-07-24
* [Vite](https://github.com/vitejs/awesome-vite) ⭐ 17,243 | 🐛 142 | 🌐 JavaScript | 📅 2026-02-04
...
* [vite](https://github.com/vitejs/vite) ⭐ 82,768 | 🐛 762 | 🌐 TypeScript | 📅 2026-09-08 - Next generation frontend tooling. It's fast.
* [vue-next](https://github.com/vuejs/vue-next) ⭐ 54,349 | 🐛 903 | 🌐 TypeScript | 📅 2026-09-09 - Repo for Vue 3.0
* [headlessui-vue](https://github.com/tailwindlabs/headlessui) ⭐ 28,742 | 🐛 110 | 🌐 TypeScript | 📅 2026-04-13 - A set of completely unstyled, fully accessible UI components for Vue 3, designed to integrate beautifully with Tailwind CSS.
* [vant](https://github.com/youzan/vant) ⭐ 24,385 | 🐛 217 | 🌐 TypeScript | 📅 2026-09-09 - Lightweight Mobile UI Components built on Vue 3
* [vitepress](https://github.com/vuejs/vitepress) ⭐ 18,302 | 🐛 305 | 🌐 TypeScript | 📅 2026-09-04 - Vite & Vue powered static site generator
...
* [particles.vue3](https://github.com/matteobruni/tsparticles/blob/master/components/vue3/README.md) ⭐ 8,978 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-02 - A lightweight library for easily create highly customizable particles animations for websites
...
* [Virtua](https://github.com/inokawa/virtua) ⭐ 3,738 | 🐛 62 | 🌐 TypeScript | 📅 2026-09-09 - A zero-config, fast and small (\~3kB) virtual list component for React, Vue and Solid.
...
* [markstream-vue](https://github.com/Simon-He95/markstream-vue) ⭐ 3,002 | 🐛 0 | 🌐 Vue | 📅 2026-09-09 - A Vue 3 streaming Markdown renderer for AI chat, supporting incomplete Markdown, Mermaid, KaTeX, long responses, and streaming code blocks.
...
* [vue3-carousel](https://github.com/ismail9k/vue3-carousel) ⭐ 885 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-07 - Modern lightweight carousel component built for Vue 3.
