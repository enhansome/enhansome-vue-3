...
* [General](https://github.com/vuejs/awesome-vue) ⭐ 73,544 | 🐛 105 | 📅 2026-07-24
* [Vite](https://github.com/vitejs/awesome-vite) ⭐ 17,241 | 🐛 141 | 🌐 JavaScript | 📅 2026-02-04
...
* [vite](https://github.com/vitejs/vite) ⭐ 82,762 | 🐛 762 | 🌐 TypeScript | 📅 2026-09-08 - Next generation frontend tooling. It's fast.
* [vue-next](https://github.com/vuejs/vue-next) ⭐ 54,345 | 🐛 904 | 🌐 TypeScript | 📅 2026-09-08 - Repo for Vue 3.0
* [headlessui-vue](https://github.com/tailwindlabs/headlessui) ⭐ 28,741 | 🐛 110 | 🌐 TypeScript | 📅 2026-04-13 - A set of completely unstyled, fully accessible UI components for Vue 3, designed to integrate beautifully with Tailwind CSS.
* [vant](https://github.com/youzan/vant) ⭐ 24,385 | 🐛 217 | 🌐 TypeScript | 📅 2026-09-08 - Lightweight Mobile UI Components built on Vue 3
...
* [particles.vue3](https://github.com/matteobruni/tsparticles/blob/master/components/vue3/README.md) ⭐ 8,977 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-02 - A lightweight library for easily create highly customizable particles animations for websites
...
* [vue-router-next](https://github.com/vuejs/vue-router-next) ⭐ 4,673 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-07 - The Vue 3 official router (WIP)
* [composition-api](https://github.com/vuejs/composition-api) ⭐ 4,179 | 🐛 0 | 🌐 TypeScript | 📅 2023-08-15 - Vue2 plugin for the Composition API.
* [vuestic-ui](https://github.com/epicmaxco/vuestic-ui) ⭐ 3,748 | 🐛 530 | 🌐 Vue | 📅 2026-05-09 - Vue.js 3.0 UI Library
* [Virtua](https://github.com/inokawa/virtua) ⭐ 3,738 | 🐛 62 | 🌐 TypeScript | 📅 2026-09-08 - A zero-config, fast and small (\~3kB) virtual list component for React, Vue and Solid.
...
* [markstream-vue](https://github.com/Simon-He95/markstream-vue) ⭐ 2,996 | 🐛 0 | 🌐 Vue | 📅 2026-09-08 - A Vue 3 streaming Markdown renderer for AI chat, supporting incomplete Markdown, Mermaid, KaTeX, long responses, and streaming code blocks.
...
* [@vuepic/vue-datepicker](https://github.com/Vuepic/vue-datepicker) ⭐ 1,764 | 🐛 25 | 🌐 TypeScript | 📅 2026-07-08 - The most complete datepicker solution for Vue 3
* [vue-quill](https://github.com/vueup/vue-quill) ⭐ 1,346 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-06 - ✒️📝 A Vue 3 rich text editor component based on Quill Editor. See a [Live Demo](https://vueup.github.io/vue-quill/#demo).
...
* [hy-app](https://github.com/MrGao-hy/hy-design-uni) ⭐ 456 | 🐛 1 | 🌐 Vue | 📅 2026-08-24 - A Vue 3 and TypeScript UI component library for UniApp, providing mobile-first components, theme customization, dark mode support, and cross-platform compatibility.
...
* [qalendar](https://github.com/tomosterlund/qalendar) ⭐ 292 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-08 - A component library with an event calendar & datepicker.
...
* [Vue Virtual Waterfall](https://github.com/lhlyu/vue-virtual-waterfall) ⭐ 248 | 🐛 1 | 🌐 Vue | 📅 2026-08-05 - A vue3 virtual waterfall component
...
* [timer-hook](https://github.com/riderx/vue-timer-hook) ⭐ 182 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-07 - Handle timer, stopwatch, and time logic/state in your vue 3 component.
* [vue3-datagrid](https://github.com/revolist/vue3-datagrid) ⭐ 180 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-07 - Powerful virtual data grid spreadsheet for Vue 3 with advanced customization based on [revogrid](https://rv-grid.com).
...
* [Vue 3 social sharing](https://github.com/hedint/vue3-social-sharing) ⭐ 23 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-05 - Style agnostic Vue 3 plugin for sharing your links on major social networks.
...
* [vue3-realworld-example-app](https://github.com/mutoe/vue3-realworld-example-app) ⭐ 1,083 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-28 - [Realworld](https://github.com/gothinkster/realworld) ⭐ 84,206 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-26 app implementation using Vue 3 + TypeScript + Composition Api
...
* [CoreUI for Vue](https://github.com/coreui/coreui-vue) ⭐ 642 | 🐛 3 | 🌐 MDX | 📅 2026-09-08 - An Open Source UI components library for Vue 3
...
* [vite-tailwind-starter](https://github.com/posva/vite-tailwind-starter) ⭐ 458 | 🐛 5 | 🌐 Vue | 📅 2026-09-07 - Starter using Vite + Tailwind for super fast prototyping
...
* [vite-wind](https://github.com/boussadjra/vite-wind) ⭐ 111 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-07 - Boilerplate with Tailwind CSS, TypeScript, css-pro-layout, 9+ components and dark mode support.
* [vite-wind](https://github.com/boussadjra/vite-wind) ⭐ 111 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-07 - Boilerplate with Tailwind CSS, TypeScript, css-pro-layout, 9+ components and dark mode support.
...
* [vue3-ssr-realworld-example-app](https://github.com/levchak0910/vue3-ssr-realworld-example-app) ⭐ 42 | 🐛 0 | 🌐 Vue | 📅 2022-10-14 - [Realworld](https://github.com/gothinkster/realworld) ⭐ 84,206 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-26 app implementation using Vue 3 with SSR
