...
* [General](https://github.com/vuejs/awesome-vue) ⭐ 73,535 | 🐛 98 | 📅 2026-07-24
* [Vite](https://github.com/vitejs/awesome-vite) ⭐ 17,227 | 🐛 134 | 🌐 JavaScript | 📅 2026-02-04
...
* [vite](https://github.com/vitejs/vite) ⭐ 82,508 | 🐛 750 | 🌐 TypeScript | 📅 2026-08-24 - Next generation frontend tooling. It's fast.
* [vue-next](https://github.com/vuejs/vue-next) ⭐ 54,243 | 🐛 912 | 🌐 TypeScript | 📅 2026-08-24 - Repo for Vue 3.0
* [headlessui-vue](https://github.com/tailwindlabs/headlessui) ⭐ 28,720 | 🐛 109 | 🌐 TypeScript | 📅 2026-04-13 - A set of completely unstyled, fully accessible UI components for Vue 3, designed to integrate beautifully with Tailwind CSS.
* [vant](https://github.com/youzan/vant) ⭐ 24,373 | 🐛 222 | 🌐 TypeScript | 📅 2026-08-24 - Lightweight Mobile UI Components built on Vue 3
* [vitepress](https://github.com/vuejs/vitepress) ⭐ 18,231 | 🐛 314 | 🌐 TypeScript | 📅 2026-08-24 - Vite & Vue powered static site generator
...
* [particles.vue3](https://github.com/matteobruni/tsparticles/blob/master/components/vue3/README.md) ⭐ 8,961 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-13 - A lightweight library for easily create highly customizable particles animations for websites
...
* [vue-router-next](https://github.com/vuejs/vue-router-next) ⭐ 4,671 | 🐛 49 | 🌐 TypeScript | 📅 2026-08-24 - The Vue 3 official router (WIP)
...
* [Virtua](https://github.com/inokawa/virtua) ⭐ 3,724 | 🐛 67 | 🌐 TypeScript | 📅 2026-08-24 - A zero-config, fast and small (\~3kB) virtual list component for React, Vue and Solid.
...
* [markstream-vue](https://github.com/Simon-He95/markstream-vue) ⭐ 2,957 | 🐛 0 | 🌐 Vue | 📅 2026-08-24 - A Vue 3 streaming Markdown renderer for AI chat, supporting incomplete Markdown, Mermaid, KaTeX, long responses, and streaming code blocks.
...
* [@vuepic/vue-datepicker](https://github.com/Vuepic/vue-datepicker) ⭐ 1,762 | 🐛 23 | 🌐 TypeScript | 📅 2026-07-08 - The most complete datepicker solution for Vue 3
* [vue-quill](https://github.com/vueup/vue-quill) ⭐ 1,347 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-23 - ✒️📝 A Vue 3 rich text editor component based on Quill Editor. See a [Live Demo](https://vueup.github.io/vue-quill/#demo).
...
* [vue-test-utils-next](https://github.com/vuejs/vue-test-utils-next) ⭐ 1,156 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-22 - The next iteration of Vue Test Utils, targeting Vue 3
...
* [hy-app](https://github.com/MrGao-hy/hy-design-uni) ⭐ 447 | 🐛 1 | 🌐 Vue | 📅 2026-08-24 - A Vue 3 and TypeScript UI component library for UniApp, providing mobile-first components, theme customization, dark mode support, and cross-platform compatibility.
...
* [timer-hook](https://github.com/riderx/vue-timer-hook) ⭐ 182 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-24 - Handle timer, stopwatch, and time logic/state in your vue 3 component.
* [vue3-datagrid](https://github.com/revolist/vue3-datagrid) ⭐ 178 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-24 - Powerful virtual data grid spreadsheet for Vue 3 with advanced customization based on [revogrid](https://rv-grid.com).
...
* [vue3-realworld-example-app](https://github.com/mutoe/vue3-realworld-example-app) ⭐ 1,078 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-01 - [Realworld](https://github.com/gothinkster/realworld) ⭐ 84,136 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-13 app implementation using Vue 3 + TypeScript + Composition Api
...
* [Tailwindadmin](https://github.com/Tailwind-Admin/free-tailwind-admin-dashboard-template) ⭐ 263 | 🐛 1 | 🌐 TypeScript | 📅 2026-05-26 - A free, open-source Shadcn UI admin dashboard template supporting React, Next.js, Angular, and Vue.js.
...
* [vue3-ssr-realworld-example-app](https://github.com/levchak0910/vue3-ssr-realworld-example-app) ⭐ 42 | 🐛 0 | 🌐 Vue | 📅 2022-10-14 - [Realworld](https://github.com/gothinkster/realworld) ⭐ 84,136 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-13 app implementation using Vue 3 with SSR
