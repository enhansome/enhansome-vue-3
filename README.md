...
* [General](https://github.com/vuejs/awesome-vue) ⭐ 73,550 | 🐛 103 | 📅 2026-07-24
* [Vite](https://github.com/vitejs/awesome-vite) ⭐ 17,236 | 🐛 136 | 🌐 JavaScript | 📅 2026-02-04
...
* [vite](https://github.com/vitejs/vite) ⭐ 82,640 | 🐛 767 | 🌐 TypeScript | 📅 2026-09-01 - Next generation frontend tooling. It's fast.
* [vue-next](https://github.com/vuejs/vue-next) ⭐ 54,287 | 🐛 900 | 🌐 TypeScript | 📅 2026-09-01 - Repo for Vue 3.0
* [headlessui-vue](https://github.com/tailwindlabs/headlessui) ⭐ 28,730 | 🐛 109 | 🌐 TypeScript | 📅 2026-04-13 - A set of completely unstyled, fully accessible UI components for Vue 3, designed to integrate beautifully with Tailwind CSS.
* [vant](https://github.com/youzan/vant) ⭐ 24,382 | 🐛 213 | 🌐 TypeScript | 📅 2026-09-01 - Lightweight Mobile UI Components built on Vue 3
* [vitepress](https://github.com/vuejs/vitepress) ⭐ 18,269 | 🐛 303 | 🌐 TypeScript | 📅 2026-08-30 - Vite & Vue powered static site generator
* [vee-validate](https://github.com/logaretm/vee-validate) ⭐ 11,264 | 🐛 172 | 🌐 TypeScript | 📅 2026-03-04 - VeeValidate (v4) Vue 3 Template driven form validation
* [particles.vue3](https://github.com/matteobruni/tsparticles/blob/master/components/vue3/README.md) ⭐ 8,974 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-31 - A lightweight library for easily create highly customizable particles animations for websites
...
* [vue-router-next](https://github.com/vuejs/vue-router-next) ⭐ 4,673 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-01 - The Vue 3 official router (WIP)
...
* [Virtua](https://github.com/inokawa/virtua) ⭐ 3,731 | 🐛 63 | 🌐 TypeScript | 📅 2026-09-01 - A zero-config, fast and small (\~3kB) virtual list component for React, Vue and Solid.
* [vue-toastification](https://github.com/Maronato/vue-toastification) ⭐ 3,367 | 🐛 65 | 🌐 TypeScript | 📅 2024-02-27 - 🍞 Light, easy, and beautiful Toasts for Vue 2 and 3.
* [markstream-vue](https://github.com/Simon-He95/markstream-vue) ⭐ 2,980 | 🐛 3 | 🌐 Vue | 📅 2026-09-01 - A Vue 3 streaming Markdown renderer for AI chat, supporting incomplete Markdown, Mermaid, KaTeX, long responses, and streaming code blocks.
...
* [@vuepic/vue-datepicker](https://github.com/Vuepic/vue-datepicker) ⭐ 1,761 | 🐛 24 | 🌐 TypeScript | 📅 2026-07-08 - The most complete datepicker solution for Vue 3
* [vue-quill](https://github.com/vueup/vue-quill) ⭐ 1,346 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-30 - ✒️📝 A Vue 3 rich text editor component based on Quill Editor. See a [Live Demo](https://vueup.github.io/vue-quill/#demo).
...
* [vue-test-utils-next](https://github.com/vuejs/vue-test-utils-next) ⭐ 1,158 | 🐛 35 | 🌐 TypeScript | 📅 2026-08-27 - The next iteration of Vue Test Utils, targeting Vue 3
...
* [vue3-carousel](https://github.com/ismail9k/vue3-carousel) ⭐ 882 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-07 - Modern lightweight carousel component built for Vue 3.
...
* [vue-concurrency](https://github.com/MartinMalinda/vue-concurrency) ⭐ 359 | 🐛 32 | 🌐 TypeScript | 📅 2026-01-22 - 🚦 A library for encapsulating asynchronous operations and managing concurrency for Vue and Composition API.
...
* [timer-hook](https://github.com/riderx/vue-timer-hook) ⭐ 182 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-31 - Handle timer, stopwatch, and time logic/state in your vue 3 component.
...
* [Everright-filter](https://github.com/Liberty-liu/Everright-filter) ⭐ 110 | 🐛 6 | 🌐 JavaScript | 📅 2023-10-12 - A query builder component for Vue3. Supports filtering of multiple data types, including string, number, dropdown, cascade, region, date, and time.
...
* [vue-cookie-next](https://github.com/anish2690/vue-cookie-next) ⭐ 51 | 🐛 5 | 🌐 TypeScript | 📅 2023-12-04 - 🍪 A vue 3 plugin for handling browser cookies with typescript support.
...
* [vue3-realworld-example-app](https://github.com/mutoe/vue3-realworld-example-app) ⭐ 1,081 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-28 - [Realworld](https://github.com/gothinkster/realworld) ⭐ 84,176 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-26 app implementation using Vue 3 + TypeScript + Composition Api
...
* [CoreUI for Vue](https://github.com/coreui/coreui-vue) ⭐ 642 | 🐛 4 | 🌐 MDX | 📅 2026-09-01 - An Open Source UI components library for Vue 3
...
* [vite-tailwind-starter](https://github.com/posva/vite-tailwind-starter) ⭐ 458 | 🐛 5 | 🌐 Vue | 📅 2026-08-31 - Starter using Vite + Tailwind for super fast prototyping
...
* [vite-wind](https://github.com/boussadjra/vite-wind) ⭐ 111 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-31 - Boilerplate with Tailwind CSS, TypeScript, css-pro-layout, 9+ components and dark mode support.
* [vite-wind](https://github.com/boussadjra/vite-wind) ⭐ 111 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-31 - Boilerplate with Tailwind CSS, TypeScript, css-pro-layout, 9+ components and dark mode support.
...
* [YummyAdmin](https://github.com/doroudi/YummyAdmin) ⭐ 67 | 🐛 12 | 🌐 Vue | 📅 2026-06-16 - 📈 Totaly free Vue 3 Dashboard template based on NaiveUI, Typescript, MSW, Tailwindcss, multilanguage, fully RTL support and production ready.
...
* [vue3-ssr-realworld-example-app](https://github.com/levchak0910/vue3-ssr-realworld-example-app) ⭐ 42 | 🐛 0 | 🌐 Vue | 📅 2022-10-14 - [Realworld](https://github.com/gothinkster/realworld) ⭐ 84,176 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-26 app implementation using Vue 3 with SSR
