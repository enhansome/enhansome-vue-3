...
* [General](https://github.com/vuejs/awesome-vue) ⭐ 73,549 | 🐛 101 | 📅 2026-07-24
...
* [vite](https://github.com/vitejs/vite) ⭐ 82,622 | 🐛 773 | 🌐 TypeScript | 📅 2026-08-31 - Next generation frontend tooling. It's fast.
* [vue-next](https://github.com/vuejs/vue-next) ⭐ 54,284 | 🐛 900 | 🌐 TypeScript | 📅 2026-08-31 - Repo for Vue 3.0
* [headlessui-vue](https://github.com/tailwindlabs/headlessui) ⭐ 28,728 | 🐛 109 | 🌐 TypeScript | 📅 2026-04-13 - A set of completely unstyled, fully accessible UI components for Vue 3, designed to integrate beautifully with Tailwind CSS.
* [vant](https://github.com/youzan/vant) ⭐ 24,384 | 🐛 213 | 🌐 TypeScript | 📅 2026-08-31 - Lightweight Mobile UI Components built on Vue 3
* [vitepress](https://github.com/vuejs/vitepress) ⭐ 18,263 | 🐛 303 | 🌐 TypeScript | 📅 2026-08-30 - Vite & Vue powered static site generator
...
* [particles.vue3](https://github.com/matteobruni/tsparticles/blob/master/components/vue3/README.md) ⭐ 8,973 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-31 - A lightweight library for easily create highly customizable particles animations for websites
...
* [Virtua](https://github.com/inokawa/virtua) ⭐ 3,731 | 🐛 64 | 🌐 TypeScript | 📅 2026-08-31 - A zero-config, fast and small (\~3kB) virtual list component for React, Vue and Solid.
...
* [markstream-vue](https://github.com/Simon-He95/markstream-vue) ⭐ 2,977 | 🐛 2 | 🌐 Vue | 📅 2026-08-31 - A Vue 3 streaming Markdown renderer for AI chat, supporting incomplete Markdown, Mermaid, KaTeX, long responses, and streaming code blocks.
...
* [vue3-realworld-example-app](https://github.com/mutoe/vue3-realworld-example-app) ⭐ 1,081 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-28 - [Realworld](https://github.com/gothinkster/realworld) ⭐ 84,170 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-26 app implementation using Vue 3 + TypeScript + Composition Api
...
* [Tailwindadmin](https://github.com/Tailwind-Admin/free-tailwind-admin-dashboard-template) ⭐ 266 | 🐛 1 | 🌐 TypeScript | 📅 2026-05-26 - A free, open-source Shadcn UI admin dashboard template supporting React, Next.js, Angular, and Vue.js.
...
* [vue3-ssr-realworld-example-app](https://github.com/levchak0910/vue3-ssr-realworld-example-app) ⭐ 42 | 🐛 0 | 🌐 Vue | 📅 2022-10-14 - [Realworld](https://github.com/gothinkster/realworld) ⭐ 84,170 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-26 app implementation using Vue 3 with SSR
