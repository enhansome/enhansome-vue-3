...
* [Vite](https://github.com/vitejs/awesome-vite) ⭐ 17,254 | 🐛 140 | 🌐 JavaScript | 📅 2026-02-04
...
* [vite](https://github.com/vitejs/vite) ⭐ 83,018 | 🐛 784 | 🌐 TypeScript | 📅 2026-09-25 - Next generation frontend tooling. It's fast.
* [vue-next](https://github.com/vuejs/vue-next) ⭐ 54,446 | 🐛 913 | 🌐 TypeScript | 📅 2026-09-26 - Repo for Vue 3.0
* [headlessui-vue](https://github.com/tailwindlabs/headlessui) ⭐ 28,754 | 🐛 111 | 🌐 TypeScript | 📅 2026-04-13 - A set of completely unstyled, fully accessible UI components for Vue 3, designed to integrate beautifully with Tailwind CSS.
* [vant](https://github.com/youzan/vant) ⭐ 24,383 | 🐛 224 | 🌐 TypeScript | 📅 2026-09-25 - Lightweight Mobile UI Components built on Vue 3
* [vitepress](https://github.com/vuejs/vitepress) ⭐ 18,351 | 🐛 313 | 🌐 TypeScript | 📅 2026-09-26 - Vite & Vue powered static site generator
...
* [particles.vue3](https://github.com/matteobruni/tsparticles/blob/master/components/vue3/README.md) ⭐ 8,984 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-25 - A lightweight library for easily create highly customizable particles animations for websites
...
* [vue-router-next](https://github.com/vuejs/vue-router-next) ⭐ 4,687 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-25 - The Vue 3 official router (WIP)
...
* [vue-quill](https://github.com/vueup/vue-quill) ⭐ 1,348 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-20 - ✒️📝 A Vue 3 rich text editor component based on Quill Editor. See a [Live Demo](https://vueup.github.io/vue-quill/#demo).
...
* [hy-app](https://github.com/MrGao-hy/hy-design-uni) ⭐ 463 | 🐛 1 | 🌐 Vue | 📅 2026-09-21 - A Vue 3 and TypeScript UI component library for UniApp, providing mobile-first components, theme customization, dark mode support, and cross-platform compatibility.
...
* [vue3-realworld-example-app](https://github.com/mutoe/vue3-realworld-example-app) ⭐ 1,081 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-28 - [Realworld](https://github.com/gothinkster/realworld) ⭐ 84,233 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-26 app implementation using Vue 3 + TypeScript + Composition Api
...
* [vue3-ssr-realworld-example-app](https://github.com/levchak0910/vue3-ssr-realworld-example-app) ⭐ 43 | 🐛 0 | 🌐 Vue | 📅 2022-10-14 - [Realworld](https://github.com/gothinkster/realworld) ⭐ 84,233 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-26 app implementation using Vue 3 with SSR
