...
* [General](https://github.com/vuejs/awesome-vue) ⭐ 73,544 | 🐛 83 | 📅 2026-09-24
...
* [vite](https://github.com/vitejs/vite) ⭐ 82,997 | 🐛 780 | 🌐 TypeScript | 📅 2026-09-25 - Next generation frontend tooling. It's fast.
* [vue-next](https://github.com/vuejs/vue-next) ⭐ 54,438 | 🐛 905 | 🌐 TypeScript | 📅 2026-09-25 - Repo for Vue 3.0
* [headlessui-vue](https://github.com/tailwindlabs/headlessui) ⭐ 28,753 | 🐛 111 | 🌐 TypeScript | 📅 2026-04-13 - A set of completely unstyled, fully accessible UI components for Vue 3, designed to integrate beautifully with Tailwind CSS.
* [vant](https://github.com/youzan/vant) ⭐ 24,383 | 🐛 224 | 🌐 TypeScript | 📅 2026-09-25 - Lightweight Mobile UI Components built on Vue 3
* [vitepress](https://github.com/vuejs/vitepress) ⭐ 18,346 | 🐛 312 | 🌐 TypeScript | 📅 2026-09-24 - Vite & Vue powered static site generator
...
* [particles.vue3](https://github.com/matteobruni/tsparticles/blob/master/components/vue3/README.md) ⭐ 8,985 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-23 - A lightweight library for easily create highly customizable particles animations for websites
* [vuelidate-next](https://github.com/vuelidate/vuelidate/tree/next) ⭐ 6,867 | 🐛 212 | 🌐 JavaScript | 📅 2025-06-10 - Vuelidate (next) - Simple, lightweight model-based validation
* [vue-router-next](https://github.com/vuejs/vue-router-next) ⭐ 4,685 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-25 - The Vue 3 official router (WIP)
...
* [Virtua](https://github.com/inokawa/virtua) ⭐ 3,747 | 🐛 59 | 🌐 TypeScript | 📅 2026-09-24 - A zero-config, fast and small (\~3kB) virtual list component for React, Vue and Solid.
* [vue-toastification](https://github.com/Maronato/vue-toastification) ⭐ 3,367 | 🐛 64 | 🌐 TypeScript | 📅 2024-02-27 - 🍞 Light, easy, and beautiful Toasts for Vue 2 and 3.
* [markstream-vue](https://github.com/Simon-He95/markstream-vue) ⭐ 3,021 | 🐛 1 | 🌐 Vue | 📅 2026-09-22 - A Vue 3 streaming Markdown renderer for AI chat, supporting incomplete Markdown, Mermaid, KaTeX, long responses, and streaming code blocks.
...
* [@vuepic/vue-datepicker](https://github.com/Vuepic/vue-datepicker) ⭐ 1,766 | 🐛 28 | 🌐 TypeScript | 📅 2026-07-08 - The most complete datepicker solution for Vue 3
...
* [vue-test-utils-next](https://github.com/vuejs/vue-test-utils-next) ⭐ 1,158 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-25 - The next iteration of Vue Test Utils, targeting Vue 3
...
* [vue3-carousel](https://github.com/ismail9k/vue3-carousel) ⭐ 883 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-24 - Modern lightweight carousel component built for Vue 3.
...
* [hy-app](https://github.com/MrGao-hy/hy-design-uni) ⭐ 460 | 🐛 1 | 🌐 Vue | 📅 2026-09-21 - A Vue 3 and TypeScript UI component library for UniApp, providing mobile-first components, theme customization, dark mode support, and cross-platform compatibility.
...
* [qalendar](https://github.com/tomosterlund/qalendar) ⭐ 293 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-25 - A component library with an event calendar & datepicker.
...
* [timer-hook](https://github.com/riderx/vue-timer-hook) ⭐ 182 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-25 - Handle timer, stopwatch, and time logic/state in your vue 3 component.
...
* [Vue 3 social sharing](https://github.com/hedint/vue3-social-sharing) ⭐ 23 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-23 - Style agnostic Vue 3 plugin for sharing your links on major social networks.
...
* [vue3-realworld-example-app](https://github.com/mutoe/vue3-realworld-example-app) ⭐ 1,081 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-28 - [Realworld](https://github.com/gothinkster/realworld) ⭐ 84,235 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-26 app implementation using Vue 3 + TypeScript + Composition Api
...
* [Tailwindadmin](https://github.com/Tailwind-Admin/free-tailwind-admin-dashboard-template) ⭐ 278 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-26 - A free, open-source Shadcn UI admin dashboard template supporting React, Next.js, Angular, and Vue.js.
...
* [vue3-ssr-realworld-example-app](https://github.com/levchak0910/vue3-ssr-realworld-example-app) ⭐ 43 | 🐛 0 | 🌐 Vue | 📅 2022-10-14 - [Realworld](https://github.com/gothinkster/realworld) ⭐ 84,235 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-26 app implementation using Vue 3 with SSR
